...
independent programs can too, beacuse sockets are system-wide, much like fifos;
...
caveat: prints in threads may beed to be synchronized if their output overlaps;
"""
...
def server():
    ...
    while True:
        ...
        reply = f'server got: [{data}]'         # conn is new connected socket
